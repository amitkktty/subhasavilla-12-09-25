        ...
        <div class="row pt-45">
            ...
            <div class="col-lg-12 col-md-12 text-center">
                <div class="pagination-area">
                    <a href="team.php" class="prev page-numbers">
                        <i class='bx bx-left-arrow-alt'></i>
                    </a>

                    <span class="page-numbers current" aria-current="page">1</span>
                    <a href="team.php" class="page-numbers">2</a>
                    <a href="team.php" class="page-numbers">3</a>

                    <a href="team.php" class="next page-numbers">
